...
Not all lists are easily coerced into data frames by simply calling `content() %>% as_tibble()`. Unless your list is perfectly structured, this will not work. OMDB example with "Sharkando" (you need your own API key to make this work -- replace it when it says "omdb_key"):
